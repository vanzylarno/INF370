...
namespace Test
{
    public partial class Add_Messaging_Contact : MetroFramework.Forms.MetroForm
    {
        public Add_Messaging_Contact()
        {
            InitializeComponent();
        }

        private void Add_Messaging_Contact_Load(object sender, EventArgs e)
        {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    sqlcon.Open();
                    string cmd = "Insert into Messaging(ContactName, ContactPhoneNumber) VALUES(@ContactName, @EmailAddress)";
